		...
		<section className="section container" id="projects">
			...
			<div className="project-grid">
				<article className="project-card">
					<img src="../public/images/chess.png" alt="Chess" />
					<h3>Chess Game</h3>
					<p>
				...
				<article className="project-card">
					<img src="../public/images/imageCompression.png" alt="Image Compression" />
				...
				<article className="project-card">
					<img src="../public/images/cougsConnect.png" alt="Cougs Connect Social Media Page" />
				...
				<article className="project-card">
					<img src="../public/images/tictactoe.png" alt="Ultimate Tic Tac Toe" />
