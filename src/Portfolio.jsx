  ...
  return (
    <div>
      ...
      <main>
        ...
        {/* Education  */}
        <section class="section container education-section" id="education">
        ...
        <div class="education-card">
          ...
          <div class="edu-details">
            <h3 class="edu-school">Brigham Young University — Expected May 2027</h3>
            <em><p class="edu-location">Provo, UT</p></em>
            <p class="edu-degree">
              Computer Science
            </p>
            <p class="edu-gpa"><strong>GPA:</strong> 3.97</p>
        ...
        <div class="experience-grid">
          ...
          <article class="experience-card">
            ...
            <div class="exp-details-block">
              ...
              <p class="exp-company">Brigham Young University · September 2025 – Present</p>
          ...
          <article class="experience-card">
            ...
            <div class="exp-details-block">
              <h3>Supervisor</h3>
              <p class="exp-company">Papa Murphy's Pizza · June 2022 - August 2023</p>
              <ul class="exp-details">
        ...
        <div className="project-grid">
          <article className="project-card">
            ...
            />
            <h3>Chess Game</h3>
            <p>Features a networked client-server architecture, 
              with a command-line client, a server to manage users and games, 
              and shared modules for implementing chess rules and game state management.</p>
          ...
          <article className="project-card">
            ...
            <p>Uses pixel approximation to optimize the .PNG deflation algorithm. On large files, managed to decrease size by <strong>more than 80%</strong></p>
            <div className="project-tags">
          ...
          <article className="project-card">
            <img
              src="cougsConnect.png"
              alt="Cougs Connect Social Media Page"
            />
            <h3>CougsConnect - Social Media Web App</h3>
            <p>Developed a social media web app in a <strong>team of 3</strong> during an <strong>18-hour hackathon</strong> for college freshmen. Includes <strong>AI powered</strong> post filtering to enhance event discovery.</p>
            <div className="project-tags">
          ...
          <article className="project-card">
            ...
            <p>Web game where you have to win three entire games of Tic-Tac-Toe in a valid order to win the outer game.</p>
            <div className="project-tags">
              <span className="project-tag">HTML/CSS</span>
        ...
        <section className="section container" id="skills">
          ...
          <div className="skills-list">
            <span className="skill-item">Frontend: React, Vue, TypeScript</span>
            <span className="skill-item">Backend: Node, Express</span>
            <span className="skill-item">UI: Figma, Design Systems</span>
            <span className="skill-item">Testing: Jest, Playwright</span>
            <span className="skill-item">DevOps: Vite, Webpack, CI/CD</span>
          </div>
        </section>
        ...
        <section className="section container about-section" id="about">
          <div>
            ...
            <p className="about-bio">
              I’m a developer who blends engineering discipline with product sense.
              I care about clarity, semantic HTML, and performance budgets.
            </p>
          </div>
          <aside className="project-card">
            <h3>Quick info</h3>
            <p><strong>Location:</strong> Provo, UT</p>
            <p><strong>Focus:</strong> Frontend Engineering</p>
            <p><strong>Available for:</strong> Freelance & full‑time</p>
            <div className="project-tags">
              <span className="project-tag">Remote‑friendly</span>
              <span className="project-tag">Open to collaboration</span>
            </div>
          </aside>
        </section>
      ...
      <footer className="site-footer">
        <div className="container">
          © {new Date().getFullYear()} Your Name · Built with React & a refined dark theme
        </div>
      </footer>
    </div>
  );
